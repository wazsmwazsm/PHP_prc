...
//因为得到的是一个二维数组，所以要变更
$record = count($my->getAll("select * from user_list"));
...
if($result === false){
	...
	{
		echo "<tr>";
		foreach($rec as $col => $cvalue)
		{
			echo "<td>".$cvalue."</td>";	
		}
		echo "<td><a href='javascript:void(0)' onclick='con_del(".$rec['id'].",".$page.")'>删除</a></td>";
		echo "</tr>";
